...
export function getTypeClassName(type: string): string {
  // Use explicit dark colors for editor content (not theme variables)
  // This ensures text is always visible on white/light backgrounds
  switch (type) {
    case "h1":
      return "text-4xl font-bold text-gray-900 leading-[1.2] mb-2"
    case "h2":
      return "text-3xl font-bold text-gray-900 leading-[1.2] mb-1.5"
    case "h3":
      return "text-2xl font-bold text-gray-900 leading-[1.2] mb-1"
    case "h4":
      return "text-xl font-semibold text-gray-900 leading-[1.3] mb-1"
    case "h5":
      return "text-lg font-semibold text-gray-900 leading-[1.4] mb-0.5"
    case "h6":
      return "text-base font-semibold text-gray-900 leading-[1.4] mb-0.5"
    case "p":
      return "text-base text-gray-800 leading-[1.6]"
    case "ol":
      return "text-base text-gray-800 leading-[1.6] list-decimal list-inside"
    case "li":
      return "text-base text-gray-800 leading-[1.6] list-disc list-inside"
    case "blockquote":
      return "text-base text-gray-600 italic border-l-4 border-blue-500 pl-6 py-1"
    case "code":
      return "font-mono text-sm bg-gray-100 text-gray-800 px-4 py-2 rounded-lg whitespace-pre-wrap break-words"
    default:
      return "text-base text-gray-800 leading-[1.6]"
  }
}
